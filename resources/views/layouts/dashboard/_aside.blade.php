...
<aside class="app-sidebar">
    <div class="app-sidebar__user">
        ...
        <div>
            ...
            <p class="app-sidebar__user-designation">{{ implode(', ', auth()->user()->roles->pluck('name')->toArray()) }}r</p>
        </div>
    </div>
    <ul class="app-menu">
        ...
        @if(auth()->user()->hasPermission('settings_read'))
            ...
            <li class="treeview"><a href="#" class="app-menu__item" data-toggle="treeview"><i class="app-menu__icon fa fa-gear"></i><span class="app-menu__label">Settings</span><i class="treeview-indicator fa fa-angle-right"></i></a>
